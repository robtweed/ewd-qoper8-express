  ...
  qoper8.handleMessage(message, function(resultObj) {
    ...
    if (message.error) {
      ...
      if (application) {
        ...
        if (type && q.workerResponseHandler && q.workerResponseHandler[application] && q.workerResponseHandler[application][type]) message = q.workerResponseHandler[application][type](message);
