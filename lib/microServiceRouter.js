...
function handleMicroService(message, route, destination, handleResponse) {
  ...
  //console.log('*** ewd-qoper8-express microServiceRouter: jwt = ' + token);
  ...
  if (token === '' || token === 'undefined') {
    ...
    //console.log('ewd-qoper8-express microServiceRouter - route = ' + JSON.stringify(route));
    if (route.bypassJWTCheck) {
      //console.log('** JWT check being bypassed ***');
